...
export const mr: TranslationMap = {
  // Navigation
  "nav.home": "होम",
  "nav.explore": "योजना एक्सप्लोर करा",
  "nav.education": "शिक्षण मार्ग",
  "nav.rights": "आपले हक्क जाणून घ्या",
  "nav.timeline": "सिव्हिक टाइमलाइन",
  "nav.assistant": "वयम् सहाय्यक",
  "nav.profile": "प्रोफाइल",
  "nav.section": "सिव्हिक इंटेलिजन्स",
  "nav.lifestyle": "लाइफस्टाइल प्लॅनर",
  "nav.lifestyle.desc": "मालमत्ता परवडणारी क्षमता आणि कर्ज कॅल्क्युलेटर",
  "common.upcoming": "लवकरच",
  "nav.home.desc": "तुमचा वैयक्तिक डॅशबोर्ड",
  "nav.explore.desc": "योजना, सेवा आणि हक्क",
  "nav.education.desc": "करिअर मार्ग आणि शिक्षण पर्याय",
  "nav.rights.desc": "कायदेशीर हक्क आणि परिस्थिती मार्गदर्शक",
